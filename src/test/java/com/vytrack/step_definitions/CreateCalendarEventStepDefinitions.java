...
public class CreateCalendarEventStepDefinitions {
    ...
    @Then("user verifies title description is {string}")
    public void user_verifies_title_description_is(String string) {
        Assert.assertEquals ( string, calendarEventsPage.getGeneralInfoDescriptionText () );
    }

    @Then("user should verify that title of new calendar event is {string}")
    public void user_should_verify_that_title_of_new_calendar_event_is(String string) {
